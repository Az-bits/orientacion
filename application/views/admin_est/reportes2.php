                            ...
                            <table id="default-datatable" class=" table-bordered" style="width:100%;">
                                ...
                                <tbody>
                                    <tr style="font-size:14px;">
                                        <td>1</td>
                                        <td>LISTA DE ESTUDIANTES QUE REALIZARON EL TEST DE INTELIGENCIA</td>

                                        <td>
                                          <!-- para imprimir en pdf -->
                                          <a href="<?php echo base_url(Hasher::make(350)); ?>" class="btn btn-danger btn-sm  btn-round btn-lg btn-outline-danger waves-effect waves-light m-1" target="_blank" type="button"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> GENERAR PDF</a>
                                        ...
                                        <td>
                                          <a href="<?php echo base_url(Hasher::make(357)); ?>" class="btn btn-danger btn-sm  btn-round btn-lg btn-outline-success waves-effect waves-light m-1" target="_blank" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> GENERAR EXCEL</a>
                                          <button type="button" class="btn btn-sm btn-success  btn-round  btn-outline-success btn-round waves-effect waves-light m-1" data-toggle="modal" data-target="#reporte_intervalo_fecha_excel"><span class="fa fa-file-excel-o"></span> GENERAR POR FECHAS</button>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                          ...
                                          <a href="<?php echo base_url(Hasher::make(361)); ?>" class="btn btn-danger btn-sm  btn-round btn-lg btn-outline-danger waves-effect waves-light m-1" target="_blank" type="button"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> GENERAR PDF</a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-primary animated bounceIn">
          ...
          <div class="modal-body">
            <form id="guardar_nuevo_usuario" method="post" accept-charset="utf-8" action="<?php echo base_url(Hasher::make(354)) ?>">
              <div class="row">
                  <div class="col-lg-4">
...
<div class="modal fade" id="reporte_intervalo_fecha_excel">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-primary animated bounceIn">
          ...
          <div class="modal-body">
            <form id="guardar_nuevo_usuario" method="post" accept-charset="utf-8" action="<?php echo base_url(Hasher::make(3571)) ?>">
              <div class="row">
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label for="input-1">DESDE</label>
