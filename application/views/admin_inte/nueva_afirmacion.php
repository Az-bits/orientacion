    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">TEST INTELIGENCIA / NUEVA AFIRMACION</li>
            </ol>
        </div>
    </div>
    <!-- End Breadcrumb-->
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fer_text" align="center">NUEVA AFIRMACION DE TEST INTELIGENCIA</h4>
                                            ...
                                            <div class="panel-body row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control input-sm" name="pregunta" placeholder="Pregunta de Test Inteligencia" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-11">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="id_area" class="form-control input-sm" required>
                                                            ...
                                                            <?php foreach ($this->db->query("SELECT * FROM inteligencia  WHERE estado='1'")->result() as $value) {
                                                                if ($value->idinteligencia != 0) { ?>
                                                                    <option value="<?php echo $value->idinteligencia ?>"><?php echo $value->nombre_inteligencia ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <a href="<?php echo base_url(Hasher::make(61)); ?>" class="btn btn-outline-danger  btn-lg mb-2"><span class="fa fa-close"></span> CANCELAR</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    $("#guardar_nueva_pregunta_test").submit(function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Controller_administracion/guardar_nueva_afirmacion_test',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
