    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">TEST INTERES PROFESIONAL / EDITAR</li>
            </ol>
        </div>
    </div>
    <!-- End Breadcrumb-->
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fer_text" align="center">EDITAR ACTIVIDAD DE INTERES</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-body">
                                        ...
                                        <input type="hidden"  name="id" value="<?php echo $obj->idpreguntas3?>">
                                        <div class="panel-body row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                    <label>ACTIVIDAD</label>
                                                        <input type="text" class="form-control input-sm" name="pregunta" placeholder="Pregunta de Test vocacional" value="<?php echo $obj->nom_pregunta3 ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-11">
                                                    <div class="form-group ">
                                                    <label>AREA DE LA ACTIVIDAD</label>
                                                        <select name="id_area" class="form-control input-sm" required>
                                                            <option></option>
                                                            <?php foreach ($this->db->get("area_interes")->result() as $value) {
                                                                if ($value->idinteres != 0) { ?>
                                                                    <option value="<?php echo $value->idinteres ?>" <?php if ($value->idinteres == $obj->idinteres) echo "selected"; ?>><?php echo $value->nombre_interes ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <a href="<?php echo base_url(Hasher::make(41)); ?>" class="btn btn-outline-primary  btn-lg mb-2"><span class="fa fa-close"></span> SALIR</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    $("#guardar_editar_pregunta_test").submit(function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Controller_administracion/guardar_actividades_editado',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
