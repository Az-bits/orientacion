    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">TEST AREA DE INTERES PROFESIONAL / NUEVA AREA DE INTERES</li>
            </ol>
        </div>
    </div>
    <!-- End Breadcrumb-->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-uppercase">
                    ...
                    <div class="media mb-3">
                        ...
                        <div class="media-body">
                            ...
                            <h4 class="text-primary m-0">ADMIN TEST AREA DE INTERES</h4>
                ...
                <div class="card-body">
                    ...
                    <h4 class="fer_text" align="center">NUEVA AREA Y CAMPOS</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="guardar_nueva_area_test" enctype="multipart/form-data">
                                        <input type="hidden"  name="id" value="<?php echo $obj->idinteres?>">
                                            <div class="panel-body row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                    <label>NOMBRE DE AREA DE INTERES</label>
                                                        <input type="text" class="form-control input-sm" name="area" placeholder="Nueva Area de test vocacional" value="<?php echo $obj->nombre_interes ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-11">
                                                    <div class="form-group ">
                                                    <label>ACTIVIDAD OCUPACIONAL</label>
                                                        <input type="text" class="form-control input-sm" name="carrera" placeholder="Carreras de la nueva area" value="<?php echo $obj->campos ?>" required>
                                                    </div>
                                                ...
                                                <a href="<?php echo base_url(Hasher::make(45)); ?>" class="btn btn-outline-danger  btn-lg mb-2"><span class="fa fa-close"></span> CANCELAR</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    $("#guardar_nueva_area_test").submit(function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Controller_administracion/guardar_area_interes_editado',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
            ...
            success: function() {
                ...
                setTimeout(function() {
                    window.location = '<?php echo base_url(Hasher::make(45)); ?>';
                }, 1000);
            }
        });
    });
