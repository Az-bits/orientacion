                                            ...
                                            <div class="panel-body row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control input-sm" name="area" placeholder="Nueva Area de interes profesional" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-11">
                                                    <div class="form-group ">
                                                        <label>ACTIVIDAD OCUPACIONAL</label>
                                                        <input type="text" class="form-control input-sm" name="actividad" placeholder="Actividad Ocupacional" required>
                                                    </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    $("#guardar_nueva_area_test").submit(function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Controller_administracion/guardar_nueva_area_interes',
            type: 'POST',
            data: formData, 
            cache: false,
            processData: false,
