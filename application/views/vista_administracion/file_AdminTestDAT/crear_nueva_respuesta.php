    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
            ...
            <h2 class="fer_text" align="center">AGREGAR RESPUESTAS</h2>
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                      <div class="card-body">
                        <form  id="guardar_respuesta_dat"  enctype="multipart/form-data">
                          ...
                          <div class="panel-body row">
                            ...
                            <div class="col-lg-2">
                              <div class="form-group">
                                ...
                                <p><img width="70" height="60" class="visualizar1" ></p>
...
<script type="text/javascript" charset="utf-8" async defer>
  ...
  $("#guardar_respuesta_dat").submit(function(event) {
    event.preventDefault();
    var formData=new FormData($("#guardar_respuesta_dat")[0]);
    $("#cargar_datos").modal({backdrop:'static',keyboard:false});
    $.ajax({
        url:'<?php echo base_url(); ?>Controller_administracion/guardar_respuesta_dat',
        type:'POST',
        data:formData,
        cache:false,
        processData:false,
