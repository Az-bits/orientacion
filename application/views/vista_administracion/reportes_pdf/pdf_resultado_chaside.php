...
// Pie de página
    ...
    function listar_est($listar_todo_inscrito){
            ...
            $this->Cell(22, 5, 'MUNICIPIO', 1, 0, 'C',1);
            ...
            foreach($listar_todo_inscrito as $lista){
                    ...
                    $this->Cell(4, 5,$contador++, 1,0,'C',1);
                    $this->Cell(22, 5, $lista->ci_est. "  LP", 1,0,'C',1);
                    $this->Cell(35, 5, utf8_decode($lista->apellido_est), 1,0,'',1);
                    $this->Cell(47, 5, utf8_decode($lista->nombre_est), 1,0,'',1);
                    $this->Cell(52, 5, utf8_decode($lista->nombre_colegio), 1,0,'',1);
