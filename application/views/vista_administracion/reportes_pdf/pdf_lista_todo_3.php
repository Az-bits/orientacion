...
// Pie de página
    ...
    public function listar_est($listar_todo_inscrito, $desde, $hasta)
    {
        ...
        $this->Ln(-7);
        $this->Cell(70);
        $this->Cell(60, 10, utf8_decode('TEST DE INTERÉS PROFESIONAL'), 0, 1, 'C');
        ...
        $this->SetX(70);
        $this->SetFont('Arial', '');
        $this->Cell(80, 10, 'LISTA DE ESTUDIANTES QUE REALIZARON EL TEST DE INTERES PROFESIONAL', 0, 1, 'C');
        ...
        $contado = $contador - 1;
        $this->Ln(5);
        $this->Cell(150, 5, ' EXISTEN UN TOTAL DE   ' . $contado . utf8_decode('   PERSONAS QUE REALIZARON EL TEST DE INTERÉS PROFESIONAL'), 1, 0, 'C', 1);
