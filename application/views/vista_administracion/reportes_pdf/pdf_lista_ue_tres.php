...
// Pie de página
    ...
    function listar_est($lista_ue_uno){
            ...
            $this->Ln(18);
            $this->Cell(70);
            $this->Cell(50,10, utf8_decode( ' TEST DE INTERÉS PROFESIONAL'),0,1,'C');
            $this->Line(10,38,200,38);


            $this->Cell(70);
            $this->Cell(50,10, utf8_decode( 'LISTA DE UNIDADES EDUCATIVAS - TEST DE INTERÉS PROFESIONAL'),0,1,'C');
