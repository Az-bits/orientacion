...
// Pie de página
    ...
    function listar_est($listar_todo_inscrito){
            ...
            $this->Ln(-6);
            $this->Cell(70);
            $this->Cell(55,10, utf8_decode('DECANATURA DE CIENCIAS DE LA EDUCACIÓN- ORIENTACIÓN VOCACIONAL 2021'),0,1,'C');
            $this->Line(10,38,200,38);
            $this->Cell(70);
            $this->Cell(50,10, utf8_decode('LISTA DE PARTICIPANTES EN LAS TRES MODALIDADES DE TEST'),0,1,'C');
            ...
            $contado=$contador-1;
            $this->Ln(5);
            $this->Cell(160, 5,' EXISTEN UN TOTAL DE   '.$contado.utf8_decode(' PERSONAS QUE PARTICIPARON EN LAS DISTINTOS EXÁMENES DE TEST DEL SISTEMA') , 1, 0, 'I',1);
            $this->Ln();
            $this->Cell(160, 5,' FECHA DE EMISION DE REPORTE   '.date('m-d-Y h:i:s a') , 1, 0, 'I',1);
