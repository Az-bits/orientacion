...
<body>
  <div class=container-fluid>
    <form class="form-register" method="POST" action="<?php echo base_url(Hasher::make(226)) ?>">
      <div style="text-align: center">
        <h4>PARA REALIZAR EL TEST INTRODUZCA LOS DATOS CORRESPONDIENTES</h4>
      </div>
    ...
    if ($value->id_departamento != 0) {?>
      ...
      <input class="botons" type="submit" value="REALIZAR TEST CHASIDE">
    ...
    <div class="form-register">
      <a href="<?php echo base_url(Hasher::make(270)) ?>"><button class="botons" type="submit" style="margin: 0px 0px 10px 0px">VOLVER A INICIO</button></a>
      <!-- <a href="<?php echo base_url(Hasher::make(27)) ?>"><button class="botons" type="submit" style="margin: 0px">Registrar Unidad Educativa</button></a> -->
    </div>
...
<script src="<?php echo base_url(); ?>assets_/admin/assets/js/global-plugins.js"></script>
