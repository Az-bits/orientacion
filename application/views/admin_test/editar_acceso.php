    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ACCESOS E INFORMACIÓN / EDITAR</li>
            </ol>
        </div>
    </div>
    <!-- End Breadcrumb-->
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fer_text" align="center">EDITAR ACCESO DE INFORMACION</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-body">
                                        ...
                                        <input type="hidden"  name="id" value="<?php echo $obj->id_acceso?>">
                                        <div class="panel-body row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        <label>TIPO</label>
                                                        <input type="text" class="form-control input-sm" name="tipo" placeholder="Pregunta de Test vocacional" value="<?php echo $obj->nombre_acceso ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-11">
                                                    <div class="form-group ">
                                                        <label>DESCRIPCIÓN</label>
                                                        <input type="text" class="form-control input-sm" name="descripcion" placeholder="Pregunta de Test vocacional" value="<?php echo $obj->descripcion ?>" required>
                                                ...
                                                <a href="<?php echo base_url(Hasher::make(48)); ?>" class="btn btn-outline-primary  btn-lg mb-2"><span class="fa fa-close"></span> SALIR</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
