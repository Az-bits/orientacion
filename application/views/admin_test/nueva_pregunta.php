        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fer_text" align="center">NUEVA PREGUNTA DE TEST VOCACIONAL</h4>
                                            ...
                                            <div class="panel-body row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control input-sm" name="pregunta" placeholder="Pregunta de Test vocacional" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-11">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="id_area" class="form-control input-sm" required>
                                                            <option></option>
                                                            <?php foreach ($this->db->query("SELECT * FROM area_pregunta  WHERE estado='1'")->result() as $value) {
                                                                if ($value->idarea_pregunta != 0) { ?>
                                                                    <option value="<?php echo $value->idarea_pregunta ?>"><?php echo $value->nombre_area ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <a href="<?php echo base_url(Hasher::make(51)); ?>" class="btn btn-outline-danger  btn-lg mb-2"><span class="fa fa-close"></span> CANCELAR</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    ...
    $("#guardar_nueva_pregunta_test").submit(function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Controller_administracion/guardar_nueva_pregunta_test',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
