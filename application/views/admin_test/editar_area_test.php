        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="fer_text" align="center">EDITAR AREA DE TEST VOCACIONAL</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-body">
                                        ...
                                        <input type="hidden"  name="id" value="<?php echo $obj->idarea_pregunta?>">
                                            <div class="panel-body row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        <label>NOMBRE DE AREA DE TEST VOCACIONAL</label>
                                                        <input type="text" class="form-control input-sm" name="area" placeholder="Nueva Area de test vocacional" value="<?php echo $obj->nombre_area ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-11">
                                                    <div class="form-group ">
                                                        <label>CARRERAS DE LA AREA</label>
                                                        <input type="text" class="form-control input-sm" name="carrera" placeholder="Carreras de la nueva area" value="<?php echo $obj->carrera ?>" required>
                                                    </div>
...
<script type="text/javascript" charset="utf-8" async defer>
    $("#guardar_nueva_area_test").submit(function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Controller_administracion/guardar_area_test_editado',
            type: 'POST',
            data: formData,
            cache: false,
            processData: false,
