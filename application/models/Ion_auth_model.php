...
class Ion_auth_model extends CI_Model
{
	...
	public function guardar_nuevo_usuario($imag,$codigo,$nombre,$apellido,$id_rol,$usu,$pas){
		$pas=$this->hash_password($pas);
		$obj=array(
			'username'=>$usu,
			'password'=>$pas,
			'email'=>$usu,
		...
		$idusuario2=$this->db->insert_id();

		$obj4=array(
			'user_id'=>$idusuario2,
			'group_id'=>$id_rol
		);
		$this->db->insert("users_groups",$obj4);
	}
	public function guardar_reset_usuario($id_user,$usuario,$pass){
