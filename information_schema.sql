...
-- Tiempo de generación: 27-04-2021 a las 20:01:09
...
--
-- Estructura Stand-in para la vista `CHANGED_PAGE_BITMAPS`
--
CREATE TABLE IF NOT EXISTS `CHANGED_PAGE_BITMAPS` (
...
--
-- Estructura Stand-in para la vista `INNODB_CHANGED_PAGES`
--
CREATE TABLE IF NOT EXISTS `INNODB_CHANGED_PAGES` (
...
--
-- Estructura Stand-in para la vista `XTRADB_INTERNAL_HASH_TABLES`
--
CREATE TABLE IF NOT EXISTS `XTRADB_INTERNAL_HASH_TABLES` (
...
--
-- Estructura Stand-in para la vista `XTRADB_READ_VIEW`
--
CREATE TABLE IF NOT EXISTS `XTRADB_READ_VIEW` (
...
--
-- Estructura Stand-in para la vista `XTRADB_RSEG`
--
CREATE TABLE IF NOT EXISTS `XTRADB_RSEG` (
...
--
-- Estructura para la vista `CHANGED_PAGE_BITMAPS`
--
...
--
-- Estructura para la vista `INNODB_CHANGED_PAGES`
--
...
--
-- Estructura para la vista `XTRADB_INTERNAL_HASH_TABLES`
--
...
--
-- Estructura para la vista `XTRADB_READ_VIEW`
--
...
--
-- Estructura para la vista `XTRADB_RSEG`
--
...
--
-- Filtros para la tabla `KEY_COLUMN_USAGE`
--
ALTER TABLE `KEY_COLUMN_USAGE`
;

--
-- Filtros para la tabla `REFERENTIAL_CONSTRAINTS`
--
ALTER TABLE `REFERENTIAL_CONSTRAINTS`
;

--
-- Filtros para la tabla `TABLE_CONSTRAINTS`
--
